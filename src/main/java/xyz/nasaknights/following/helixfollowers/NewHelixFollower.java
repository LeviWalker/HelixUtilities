...
/**
 * Just copy/pasting HelixFollower and changing the command
 * structure to the new one (2020 to current) to make it
 * directly compatible with the new Command Base. Use this
 * at your own risk, and don't forget to check out Triple
 * Helix's resources for using HelixFollower. (There should
 * be a link to them in the wiki of this repository.)
 * All credit for this class goes to Triple Helix.
 */
public abstract class NewHelixFollower extends CommandBase {
     ...
     */
    public NewHelixFollower(Path path) {
        trajectory = path;
    }
     ...
     */
    public NewHelixFollower mirror() {
        mirror = true;
        return this;
    }
     ...
     * @return the current PathFollower instance
     */
    public NewHelixFollower reverse() {
        reverse = true;
        return this;
    }
